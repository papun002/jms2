...
if(isset($_POST['submit'])){
 ...
 $sql = "INSERT INTO `plan_jms`(`admin_id`, `plan_id`, `plan_name`, `plan_duration`, `plan_price`) VALUES ('$admin_id','','$pname','$pdays','$pprice')";
...
if(isset($_GET['did'])){
    $pid = $_GET['did'];
    $sql2 = "DELETE FROM `plan_jms` WHERE `plan_id`='$pid' AND admin_id='$admin_id';";
...
<head>
 ...
 <title>Plans &mdash; <?php echo $_SESSION['admin_name']; ?> </title>
    ...
    <section class="section">
     <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
       <div class="breadcrumb-item">Add Plan</div>
      </div>
     </div>

     <div class="section-body">
      <h2 class="section-title">Add Subscription Plan</h2>
      <p class="section-lead">
       To add a plan enter plan name, plan duration and price.
      </p>
          ...
          <form action="" method="post">
           <div class="row">
            ...
            <div class="form-group col-4">
             ...
             <input type="tel" class="form-control" name="pdays">
            </div>

            <div class="form-group col-4">
             <label>Plan Price (In Rupee):</label>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped v_center" id="example">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $sql2 = "SELECT * FROM `plan_jms` WHERE admin_id='$admin_id'";
                                                    $result2 = mysqli_query($con,$sql2);
                                                    $count = 1;
...
<tr>
    ...
    <td class="align-middle"><?php echo $row1['plan_duration']; ?></td>
    <td><?php echo $row1['plan_price']; ?></td>
    <td class="no-print"><a href="#" class="btn btn-secondary">Edit</a></td>
    <td class="no-print"><a href="add_plan.php?did=<?php echo $row1['plan_id']; ?>" class="btn btn-dark" onClick="return confirm('Do you really want to delete');">Delete</a></td>
</tr>
