...
<head>
    ...
    <title>Jewellary Management &mdash; Admin Login</title>
...
<body>
    ...
    <div>
        <div class="wrapper">
            ...
            <div class="text-center mt-4 name">Jewellary Management (Admin)</div>
    ...
    if(isset($_POST['login'])){
        ...
        $sql = "SELECT * FROM admin_jms WHERE `username`='$admin_userName'; ";
        $result = mysqli_query($con,$sql);
        if(mysqli_num_rows($result)>0){
            $row=mysqli_fetch_assoc($result);
            $sql1 = "SELECT `password` FROM admin_jms WHERE `password`='$admin_password'; ";
            $result1 = mysqli_query($con,$sql1);
            if(mysqli_fetch_array($result1)>0){
                $_SESSION['admin_name'] = $row['name'];
                $_SESSION['admin_logid'] = $row['admin_id'];
