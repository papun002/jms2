            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        <h2 class="section-title">Add Categories</h2>
                        <p class="section-lead">Enter category as per your products.</p>
...
<?php
$sql2 = "SELECT `category_name` , `category_id` FROM `category_jms` WHERE client_id='$client_id';";
...
if(mysqli_num_rows($result2)>0){       
    ...
    while($row = mysqli_fetch_array($result2)){
        ...
        ?>
        <li class="list-group-item d-flex justify-content-between align-items-center"> <?php echo $row['category_name']; ?> <span class="badge badge-primary badge-pill"> </span></li>
