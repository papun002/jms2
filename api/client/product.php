...
<head>
    ...
    <title>Stock &mdash; <?php echo $_SESSION['client_name']; ?> </title>
...
if(mysqli_num_rows($result)>0){
    while($row = mysqli_fetch_array($result)){
        ...
        <?php
                                            ...
                                            <div class="form-group col-6">
                                                <label>Product Weight (In Gram)</label>
                                                <input type="text" class="form-control" name="pweight">
                                            </div>

                                            <div class="form-group col-4">
                                                <label>HUID Number</label>
                                                <input type="text" class="form-control" name="huidno">
                                            </div>
                                        ...
                                        <div class="section-title mt-0">Add Barcode :- </div>                                                                                
                                        <div class="row">
                                            <div class="form-group col-12">
                                                <label>Add Barcode</label>
                                                <input type="text" class="form-control" name="pbarcode">
                                            </div>
                                        </div>
