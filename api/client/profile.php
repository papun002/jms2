...
if (strlen($_SESSION['client_logid'] == 0)) {
    ...
    $sql4 = "SELECT `sub_status` FROM `client_sub_jms` WHERE client_id='$client_id'";
                $result4 = mysqli_query($con,$sql4);
                if($result4){
                    $row4 = mysqli_fetch_array($result4);
                    if($row4['sub_status'] == "Active"){
                        ?>
   ...
   <div class="col-12 col-md-12 col-lg-10" style="position: relative;top: 0px;left: auto;margin: auto;">
    <div class="card profile-widget">
     ...
     <div class="profile-widget-description">
      <div class="row">
       <div class="profile-widget-name"><?php echo $_SESSION['contact_person']; ?>
