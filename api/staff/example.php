...
if(mysqli_num_rows($result2)>0){
    ...
    while($row = mysqli_fetch_array($result2)){
        ?>
        <li class="list-group-item d-flex justify-content-between align-items-center"> <?php echo $row['category_name']; ?><span class="badge badge-primary badge-pill">77</span></li>
    <?php
  }
    ?>
    </ul>
