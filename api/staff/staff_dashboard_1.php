                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <?php
                            //   $date = date('Y-m-d');
$sql3 = "SELECT sum(pdt_bal) FROM `cus_details_jms` WHERE client_id = $client_id ";
$result3 = mysqli_query($con, $sql3);

if(mysqli_num_rows($result3)>0){
  while($row3= mysqli_fetch_assoc($result3)){       
  ?>
  <div class="card-body"><?php echo $row3['sum(pdt_bal)']; ?></div>
  <?php
  }
}else {
  ?>
...
?>
                                        ...
                                        <div class="statistic-details-item">
                                            <span class="text-muted"><span class="text-danger"><i
                                                        ...
                                                        <?php
                                                        $sql5 = "SELECT sum(pdt_bal) FROM `cus_details_jms` WHERE client_id = $client_id and jdate BETWEEN '2022-10-18' AND '2022-10-25'";
